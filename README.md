...
=================
   ...
   * [CPU security bugs caused by speculative execution](#cpu-security-bugs-caused-by-speculative-execution)
      ...
      * [Impacted CPU matrix](#impacted-cpu-matrix)
         ...
         * [Samsung](#samsung)
      * [PoCs](#pocs)
         * [[MISPREDICT] Google Project Zero: basic same-process PoC](#mispredict-google-project-zero-basic-same-process-poc)
         * [[MISPREDICT] Google Project Zero: arbitrary kernel reads with eBPF JIT](#mispredict-google-project-zero-arbitrary-kernel-reads-with-ebpf-jit)
         * [[BTI] Google Project Zero: HV guest root process can read host physical memory](#bti-google-project-zero-hv-guest-root-process-can-read-host-physical-memory)
         * [[PRIV-LOAD] Google Project Zero: Partial kernel memory read from userspace](#priv-load-google-project-zero-partial-kernel-memory-read-from-userspace)
      ...
      * [Software/Service Vendor response](#softwareservice-vendor-response)
         ...
         * [Microsoft Edge / IE](#microsoft-edge--ie)
         * [Google (all products)](#google-all-products)
         * [Apple](#apple-2)
